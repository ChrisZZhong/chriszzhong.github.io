...
## (Daily) What is your daily life like?
...
I will communicate with my manager and the relevant team members, I think effective communication is crucial part.
...
Initially, these tasks did seem overwhelming, but I've gradually summarized an approach to handle such situations. The key is to `prioritize the tasks`.
...
By gradually working on higher priority tasks, I've found that I can handle multiple tasks.

## (new tech) Tell me about a time when you had to learn a new technology.

For frontend, I am initially using HTML and CSS, JSTL stuff. At Bolt, we use Angular for frontend, so this is an exciting opportunity for me to learn a new frontend tech.

The challenge was to transition from the static web page to dynamic web pages. To get familiar quickly, I began with official online tutorials and online courses to know the basic knowledge.

However, when I practice in project. It is really easy to be confused by the some concepts like two way binding. So I also relied on the Angular community and online forums to seek other peoples for helps. It was a steep learning curve.

After that, I summarized the key concepts and the basic structure of Angular. I also created a cheat sheet to help me remember the syntax and the key points. I successfully completed the order tracking page using Angular.
