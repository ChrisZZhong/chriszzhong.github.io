...
I have a strong foundation in Java, and I'm experienced in building applications using Spring MVC, JDBC, and Hibernate. I've also worked with Spring Boot, Eureka, and the Feign Client to develop microservices. I have used Junit, Mockito, JaCoCo, and Selenium to do the Unit test and some of the automation tests before.
For Databases, I am experienced in MySQL and MongoDB.
For Cloud services, I've had hands-on experience with AWS S3, RDS, EC2, Cloud9.
Also, I am familiar with React and Angular for frontend.

I currently work for Bolt, Bolt provides a simple way for merchant customers to checkout and make payments. My team is responsible for order management and I am responsible for order tracking service.

My team and I are responsible for order management. I was involved in developing and maintaining the order tracking related microservices, for that I participated in the developing order tracking and notification microservice. Beside these, I am also responsible for maintaining the order tracking page using Angular. During the development, I used Factory design pattern to decoupled the app and provide an uniformed interface to handle the order tracking data provided by different carriers Apis.
...
To address this problem, I debugged the logs. We found that when we send many requests to external carrier api in a short time, some of the requests were blocked or got responses around 3-5s, generally it will respond within 1s. After searching, this may be due to their Api protection mechanism.
...
My manager, on the other hand, was concerned about the potential risk of vendor lock-in. They made a valid point about the potential risks of relying solely on AWS, especially if some day aws goes down. They believed that using Kafka offered more flexibility for future migrations, such as using GCP.

During our conversation, it became clear that we were approaching the situation from different angles. I acknowledged the importance of avoiding vendor lock-in and appreciated my manager's forward-thinking approach. Instead of being stubborn about my viewpoint, I shifted gears to find a compromise.

This experience taught me the importance of open and respectful communication when dealing with conflicts. By actively listening to my manager's perspective, being adaptable in my thinking, and arriving at a mutually agreeable compromise, we made an informed decision that benefited our application.
...
I once had a ticket to fix a critical bug, and while I was in the middle of debugging, another essential service that I depended on went down unexpectedly. At that point, I realized that the downtime of this service could significantly delay my progress, and I couldn't predict how long it would take to recover.

So, I reported the situation to my manager. At the same time, I reached out to the coworker responsible for that service. I explained the urgency of the situation, and inquired about the expected recovery time. In the end, after consulting with my manager and collaborating with the coworker, we collectively decided to reschedule the estimated time for the ticket.

Open and honest communication should be a good solution.
...
I had several features to implement and deploy within a tight timeframe, all while handling an urgent issue in the production environment and coordinating with my coworkers to discuss business requirements.
...
I then break down each task into smaller, manageable pieces. This makes it easier to focus on one sub-task at a time, which ultimately reduces stress. For instance, I might divide feature implementation into smaller development and testing phases and prioritize them based on deadlines and dependencies.

To deal with production issues, I ensure that I address the most critical and impactful issues first. I maintain a clear line of contact with my team.

By gradually working through each task and systematically prioritizing and breaking them down into manageable chunks, I've found that I can meet the necessary deadlines.
...
I graduated this year. My colleague has the policy to allow us to work while taking the master degree. The courses are available online so we can recap it in our spare time. All I need is to pass the mid and final exam.

## Why are you looking for a job change?

I believe it's important to continue growing and expanding my skill set. I'm looking for a job change because I'm eager to take on new challenges and contribute my expertise in a different environment. I'm excited to explore opportunities that will allow me to further develop my technical and leadership skills

## Have you worked on onsite/offshore global delivery model?

Yes, I have, previously we needed to have weekly meetings with offshore teams in China at night, to bridge the gap between teams, ensuring everyone was on the same page. It was a valuable experience. I know the importance of open communication and coordination across different time zones and cultures. If someone is not on the same page, the development process will be delayed sometimes, because what your team is doing is not what they expected.

## What is your salary expectation?

I am not authorized to discuss the rate, and tell the vendor to contact your employer (which is BF) for that.
